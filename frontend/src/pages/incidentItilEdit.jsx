...
import IncidentItilForm from '../components/incidentItilForm.jsx';

export default function IncidentItilEdit({ mode = 'edit' }) {
  const { id } = useParams();
  ...
  return (
    <section className="space-y-4">
      ...
      <IncidentItilForm initial={initial} onSubmit={handleSubmit} submitLabel={mode === 'create' ? 'Create' : 'Save'} />
    </section>
  );
}